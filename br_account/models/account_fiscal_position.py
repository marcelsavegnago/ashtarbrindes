...
class AccountFiscalPosition(models.Model):
    ...
    def _filter_rules(self, fpos_id, type_tax, partner, product, state):
        ...
        if rules:
            ...
            for rule in rules:
                ...
                _logger.info("===22===rules_points=====%s==",rules_points)
    ...
    def _calculate_points(self, rule, product, state, partner):
        ...
        _logger.info("===========before check=======")
        if product.fiscal_type == rule.tipo_produto:
            _logger.info("===========after check====%s======%s====",product.fiscal_type, rule.tipo_produto)
